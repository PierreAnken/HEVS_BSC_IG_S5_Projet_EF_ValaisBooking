...
namespace WebServiceRest
{
    ...
    public partial class VB_WebServiceEntities1 : DbContext
    {
        public VB_WebServiceEntities1()
            : base("name=VB_WebServiceEntities1")
        {
        }
        ...
        public virtual DbSet<RoomsInReservation> RoomsInReservations { get; set; }
